            ...
            <div className='w-[930px] mx-auto flex justify-center shadow-2xl mt-16'>
                  <div className='flex-1 justify-center items-center flex flex-col py-20 px-10'>
                        ...
                        <form className='mt-10'>
                              <input className='border-2 px-5 py-2 rounded-2xl' type="email" name="" placeholder='Email' id="" />
                              <br />
                              <input className='border-2 px-5 py-2 rounded-2xl mt-3' type="email" name="" placeholder='Password' id="" />
