...
const Register = () => {
      ...
      const handle_sign_up = async (event) => {
            ...
            try {
                  ...
                  console.log(result);
                  await update_user_profile(name, photo);
                  set_user({ ...result.user, photoURL: photo, displayName: name })
            ...
            <div className='w-[930px] mx-auto flex justify-center shadow-2xl mt-16'>
                  ...
                  <div className='flex-1 justify-center items-center flex flex-col py-20 px-10'>
                        ...
                        <form onSubmit={handle_sign_up} className='mt-10'>
                              ...
                              <input className='border-2 px-5 py-2 rounded-2xl mt-3 w-full' autoComplete='photo' type='text' name="photo" placeholder='PhotoURL' id="" />
